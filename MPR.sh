...
while true; do
    ...
    echo -e "${YELLOW}+--------------------------------------------------+${NC}"
    echo -e "${YELLOW}|                                                  |${NC}"
    echo -e "${YELLOW}|${GRAY}      ___  ___    ___     ____     _____  ___     ${YELLOW}|${NC}"
    echo -e "${YELLOW}|${GRAY}    ____  /   |  /   |   | __ \   | ___ \  ___    ${YELLOW}|${NC}"
    echo -e "${YELLOW}|${GRAY}   ____  / /| | / /| |   | \/ /   | \_/ / ____    ${YELLOW}|${NC}"
    echo -e "${YELLOW}|${GRAY}   ___  / / | |/ / | |   |  _/    |  __ \ ____    ${YELLOW}|${NC}"
    echo -e "${YELLOW}|${GRAY}   __  /_/  |___/  |_|   |_|      |_|  \_\ __     ${YELLOW}|${NC}"
    echo -e "${YELLOW}|                                        ${RED}ver 1.4 ${NC}  ${YELLOW}|${NC}"
    ...
    case $choice in
     ...
     #UPDATE SEVER
        ...
        26)
            ...
            echo -e "Special thanks to ${GREEN}Persian Guys${NC}, ${GREEN}alex${NC}, and ${GREEN}kimi${NC} for their contributions.\n"
